...
import { updateIncome } from "./incomeController.js";
...
export async function updateExpense(req,res){
    ...
    try {
        ...
        res.json({
            success:true, message:" Expense update succesfully",data:updatedExpense })
    } catch (error) {
         console.log(error);
        res.status(500).json({
            success:false,
